(function() {
  ...
  exports.app = {
    ...
    sockjs_websocket: function(req, connection, head) {
      ...
      transport.registerNoSession(req, this, new WebSocketReceiver(ws, connection));
      return true;
    },
  ...
  WebSocketReceiver = (function() {
    __extends(WebSocketReceiver, transport.GenericReceiver);
    ...
    function WebSocketReceiver(ws, connection) {
      ...
      this.ws.addEventListener('message', __bind(function(m) {
        return this.didMessage(m.data);
      }, this));
  ...
  RawWebsocketSessionReceiver = (function() {
    __extends(RawWebsocketSessionReceiver, transport.Session);
    function RawWebsocketSessionReceiver(req, conn, server, ws) {
      ...
      this._end_cb = __bind(function() {
        return this.didClose();
      }, this);
      this.ws.addEventListener('close', this._end_cb);
      this._message_cb = __bind(function(m) {
        return this.didMessage(m);
      }, this);
